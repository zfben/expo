...
exports.expoRouterServerComponentClientReferencesPlugin = exports.rscForbiddenReactAPIsPlugin = exports.environmentRestrictedImportsPlugin = void 0;
...
function environmentRestrictedImportsPlugin(api) {
    ...
    return {
        name: 'environment-restricted-imports-plugin',
        visitor: {
