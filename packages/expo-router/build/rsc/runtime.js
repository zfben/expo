...
exports.createServerReference = exports.createClientReference = void 0;
...
const deepProxyHandlers = {
    get: function (target, name, _receiver) {
        switch (name) {
            ...
            case 'Provider':
                throw new Error(`Cannot render a Client Context Provider on the Server. ` +
        ...
        throw new Error(`Cannot access ${expression} on the server. ` +
        ...
        switch (name) {
            ...
            case '__esModule':
                ...
                target.default = Object.defineProperties(function () {
                    throw new Error(`Attempted to call the default export of ${moduleId} from the server ` +
