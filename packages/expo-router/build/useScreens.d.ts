...
export declare function getQualifiedRouteComponent(value: RouteNode): React.ForwardRefExoticComponent<Pick<any, string | number | symbol> & React.RefAttributes<unknown>> | React.ComponentType<any>;
